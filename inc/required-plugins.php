 ...
 * @since 1.2.0
 */
require_once ANP_MEETINGS_PLUGIN_DIR . 'inc/libs/tgm-plugin-activation/class-tgm-plugin-activation.php';
...
if(  class_exists( 'TGM_Plugin_Activation' )  ) {
  function meetings_register_required_plugins() {
     ...
     * @var array $plugins
     */
    $plugins = apply_filters( 'anp_meetings_required_plugins', $plugins );
     ...
     * @var array $config
     */
    $config = apply_filters( 'anp_meetings_required_plugins_configs', $config );
