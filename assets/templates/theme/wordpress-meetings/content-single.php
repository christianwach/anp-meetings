...
<?php if ( 'proposal' == $post_type ) : ?>
	...
	<?php if ( $meeting_date ) : ?>
		<div class="meta meeting-meta">
			<span class="meta-label"><?php _e( 'Date Appoved:', 'wordpress-meetings' ); ?></span> <?php echo $meeting_date; ?>
		</div>
	<?php endif; ?>

	<?php if ( $effective_date) : ?>
		<div class="meta meeting-meta">
			<span class="meta-label"><?php _e( 'Date Effective:', 'wordpress-meetings' ); ?></span> <?php echo $effective_date; ?>
		</div>
	<?php endif; ?>
